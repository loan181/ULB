...
\section{Intégration de fonctions à plusieurs variables}
	...
	\subsection{Théorèmes fondamentaux}
		...
		\begin{thm} Soit $D \subset \R^2$ une surface dont le bord est une courbe simple de classe $C^1$ par morceaux. Si $P$ et $Q$ sont de classe $C^1$
		...
		\[\iint_{S_i}\scpr {\rot F}{\dif n} = \int_{\partial S_i} \scpr F{\dif l} = \sum_{k=1}^n\int_{C_k}\scpr F{(\dif x, \dif y, \dif z)}.\]
		\end{thm}
