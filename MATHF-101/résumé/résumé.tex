...
\section{Fonctions implicites et réciproques}
	\subsection{Théorème du point fixe de Banach}
		...
		\begin{lem} Si $g : \bar B(0, r) \to \R^n$ est une application contractante de constante $\alpha$ telle que $g(0)=0$, alors $I+g : \bar B(0, r) \to \R^n$
		est injective et la boule $\bar B(0, (1-\alpha)r)$ est incluse dans son image.
		\end{lem}
