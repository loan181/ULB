...
\section{Les racines primitives}
	...
	\begin{frame}
		\frametitle{Lemme 1}
		\begin{lem}[1]
			Soit $n$, un entier naturel. % On note $\varphi(p)$, la fonction indicatrice d'Euler et $p\mid q$ "$p$ divise $q$
	...
	\begin{frame}
		\begin{block}{Preuve du lemme (2) - partie 1/2}
			...
			De plus, par le théorème fondamental de l'algèbre, on sait qu'un polynôme de degré $n$ a au plus $n$ racines.
