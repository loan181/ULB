...
\chapter{Séries de Fourier}
	...
	\section{Série de Fourier d'une fonction périodique}
		...
		\subsection{Les théorèmes de Dirichlet}
			...
			\begin{thm}[Théorème de Dirichlet local] Soit $f \in \C^{1,m}_{2\pi}(\R, \C)$ et $x \in \R$. La série de Fourier de $f$ en $x$ converge vers $\frac 12(f(x^+) + f(x^-))$. i.e.~:
			\begin{equation}
			...
			et donc~:
			\begin{equation}
				\frac {f(x+2t) - f(x^-)}{\sin t} \stackrel ={t \to 0} 2f'(x^-) + o(1).
			\end{equation}
