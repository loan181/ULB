...
\chapter{Fonctions d'une variable complexe}
	...
	\subsection{Conséquences du théorème de représentabilité en série de puissances}
		\subsubsection{Ordre d'un zéro --- Principe des zéros isolés}
			...
			% Pourquoi ? f : \C \to \C : z \mapsto 0 est holomorphe et telle que Z(f) = \C qui est indénombrable...
		...
		\subsubsection{Théorème de Liouville}
			\begin{thm} Soient $a \in \C$ et $R > 0$ et $f \in H(D(a, R[)$. Par le théorème de représentabilité, il existe $(c_n)_{n \in \N} \in \C^\N$ tel que
			$R(\sum c_nz^n) \geq R$ et~:
			\begin{equation}
