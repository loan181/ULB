...
\section{Algèbre d'ensembles}
	\subsection{Définitions}
		...
		\begin{enumerate}
			...
			\item Soient $w_1, w_2 \in V_\lambda$. Alors $A(w_1 + w_2) = A(w_1) + A(w_2) = \lambda v_1 + \lambda v_2 = \lambda(v_1 + v_2)$. Dès lors $w_1+w_2 \in V_\lambda$.
		...
		\begin{proof} On sait que $\Ker(A) \coloneqq \{v \in V \tq A(v) = 0\}$. Également, $V_0 \coloneqq \{v \in V \tq A(v) = 0 \cdot v = 0\} \eqqcolon \Ker(A)$. \end{proof}
