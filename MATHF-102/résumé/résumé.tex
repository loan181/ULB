...
\section{Permutations}
	...
	\subsection{Signe d'une permutation}
		...
		\begin{prp} Soient $\sigma, \tau \in \Perm_n$. L'opérateur $\sign$ respecte les propriétés suivantes~:
...
\section{Déterminants}
	\subsection{Définitions}
		...
		multilinéaire alternée $f : V \to \R$ telle que~:
		...
		\[\det(v_1, \ldots, v_n) \coloneqq f(v_1, \ldots, v_n) = \sum_{\sigma \in \Perm_n}\sign(\sigma)\left(\prod_{i=1}^nv_{i\,\sigma(i)}\right).\] \end{proof}
