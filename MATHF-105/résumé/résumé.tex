...
\section{Espaces de probabilités}
	...
	\subsection{Notion de variables aléatoires}
		...
		\begin{déf} Soit $(\Omega, \mathcal F, \P)$ un espace de probabilité. Une variable aléatoire discrète\footnote{Souvent écrite v.a.d. ou V.A.-D.} est
		une application $X : \Omega \to E$ où $E$ est un ensemble fini ou infini dénombrable. On demande à cette application d'être mesurable. \end{déf}
		...
		\begin{déf} Soit $(\Omega, \mathcal F, \P)$ un espace de probabilité. Une variable aléatoire absolument continue\footnote{Souvent écrite v.a.c. ou V.A.-C.}
		est une application $X : \Omega \to \R$ mesurable au sens où~:
